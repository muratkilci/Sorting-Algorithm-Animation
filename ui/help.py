...
"background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(255, 0, 131, 255), stop:1 rgba(0, 157, 255, 255))")
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.label_kthsmallestelement = QtWidgets.QTabWidget(self.centralwidget)
        self.label_kthsmallestelement.setGeometry(QtCore.QRect(0, 0, 1011, 431))
        ...
        self.label_sort_algorithms.setStyleSheet("background-color: rgba(199, 204, 219,0);")
        ...
        self.label_timecomparison.setStyleSheet("background-color: rgba(199, 204, 219,0);")
        ...
        self.label.setGeometry(QtCore.QRect(50, 20, 991, 341))
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_kthsmallestelement.setTabText(self.label_kthsmallestelement.indexOf(self.help_fibonacci), _translate("MainWindow", "Fibonacci "))
        ...
        self.label_kthsmallestelement.setTabText(self.label_kthsmallestelement.indexOf(self.help_rand_sel), _translate("MainWindow", "Randomized Selection"))
        self.label_aboutme.setText(_translate("MainWindow", "<html><head/><body><p style=\"text-align: center;\"><span style=\"font-family:Georgia,serif;\"><em><span style=\"font-size:20px;\">&nbsp;This project created by Murat KILCI</span></em></span></p>\n"
"\n"
"<p style=\"text-align: center;\"><span style=\"font-family:Georgia,serif;\"><em><span style=\"font-size:20px;\">190403023</span></em></span></p></body></html>"))
